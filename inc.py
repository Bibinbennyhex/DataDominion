...
def validate_config(config: Dict[str, Any]) -> bool:
    ...
    required_fields = ["source_table", "partition_column", "destination_table", "latest_history_table", "primary_column", "primary_date_column", "max_identifier_column", "history_length", "columns", "column_transformations", "inferred_columns", "coalesce_exclusion_cols", "date_col_list", "latest_history_addon_cols", "rolling_columns", "grid_columns", "performance"]
...
def process_case_ii(spark: SparkSession, case_ii_df, config: Dict[str, Any]):
    ...
    process_total_minutes = (process_start_time - process_end_time) / 60
